...
class DescuentoBase(BaseModel):
    codigo: str = Field(..., min_length=3, max_length=20, description="Código del cupón (ej: PROMO2024)")
    porcentaje: Decimal | None = Field(None, ge=0, le=100, description="Porcentaje de 0 a 100")
    monto_fijo: Decimal | None = Field(None, ge=0, description="Descuento en valor moneda")
